...
const sendOTPEmail = async (emailId, userName, otp, choice) => {
    return new Promise((resolve, reject) => {
        ...
        const mailContent = {
            ...
            to: emailId,
            subject: (choice === "mail") ? 'Email verification for Exam Quest' : "Otp to reset password for Exam Quest",
            html: `
            <p>Dear ${userName},</p>
            <p>Greetings from Exam Quest!</p>
            ...
            <ol>
                ...
                <li>If you encounter any issues, please contact our support team at examquest4879.ase@gmail.com.</li>
            </ol>
        `
        };
