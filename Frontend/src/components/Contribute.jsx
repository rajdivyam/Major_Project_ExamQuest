      ...
      {emailValid && (
        <div className="contribute-container">
          ...
          <div className="contribute-content filter-choice">
            <label className="contributequestion" htmlFor="typefields">
          ...
          >
            {
              <>
                <label className="contributefields" htmlFor="title">
                  Year:{" "}
                </label>
                <select
                  name="academicYear"
                ...
                <select
                  name="branch"
                  className="mainpage-branch-filter"
                  required
                  id="filterByBranch"
                  onChange={handleChange}
                >
                  ...
                  {branches.map((branch) => {
                    return (
                      <option value={branch.branch} key={branch._id}>
                        {branch.branch}
                      </option>
                    );
                  })}
                ...
                <select
                  name="course"
                  required
                  className="mainpage-course-filter"
                  id="filterByCourse"
                  onChange={handleChange}
                >
                  ...
                  {courses.map((course) => {
                    return (
                      <option value={course.course} key={course._id}>
                        {course.course}
                      </option>
                    );
                  })}
            ...
            {choice === "capstone" && (
              <>
                <label className="contributefields" htmlFor="category">
                  Category:{" "}
                </label>
                ...
                {data.category != "" && (
                  <>
                    <label className="resultfields" htmlFor="title">
                      Title:{" "}
                    </label>
                    <input
                      type="text"
            ...
            {message !== "" && (
              <div className={`login-response-msg ${success}`}>{message}</div>
            )}
            {choice !== "" && (
              <>
